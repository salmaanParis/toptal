...
const SearchComponent = () => {
  ...
  return (
    ...
    className="flex flex-col md:flex-row items-center justify-center bg-white rounded-lg shadow-md overflow-hidden mt-60 p-4 z-20"
  >
    <div className="relative flex items-center border-b md:border-b-0 md:border-r p-2 w-full md:w-1/4 bg-transparent"> {/* Make this transparent */}
      ...
      <input
        ...
        className="w-full focus:outline-none p-1 text-black bg-white" // Keep the input background solid
      />
      {filteredCities.length > 0 && (
        <ul className="absolute bg-white border rounded-lg w-full mt-1 max-h-48 overflow-y-auto shadow-lg z-10">
