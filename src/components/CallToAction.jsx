...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Here, you can integrate your form submission logic (e.g., API call)
  };
          ...
          <motion.div {...fadeInUp} transition={{ delay: 0.2 }}>
            <div className="bg-white rounded-lg shadow-xl p-8">
              ...
              <div className="mt-8 aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.1422937950147!2d-73.98731968459391!3d40.74844097932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259a9b3117469%3A0xd134e199a405a163!2sEmpire%20State%20Building!5e0!3m2!1sen!2sus!4v1635181635843!5m2!1sen!2sus"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
