        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gold text-black font-semibold py-2 px-4 rounded-full hover:bg-white transition duration-300"
            >
              Discover More
            </motion.button>
          </motion.div>
            ...
            <div className="mt-8">
              ...
              <form className="flex">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-gold text-black font-semibold px-4 py-2 rounded-r-full hover:bg-white transition duration-300"
                >
                  Subscribe
                </motion.button>
              </form>
